...
This independent report retains the original joint experiment at `b60f044`. It contains
no task-delivery or output-recovery implementation. Those changes are proposed separately in
[PR #5 (task delivery)](https://github.com/msv-lab/alaya/pull/5) and
[PR #4 (output recovery)](https://github.com/msv-lab/alaya/pull/4).
This is not fresh model sampling of either standalone PR. No effect in the tables below
can be attributed to either individual feature.
...
The standalone output-recovery patch has separate validation in
[PR #4](https://github.com/msv-lab/alaya/pull/4); this report does not claim
a fresh model rerun of that patch or its revised notice.
...
Validation of the standalone implementations is recorded separately in
[PR #4](https://github.com/msv-lab/alaya/pull/4) and
[PR #5](https://github.com/msv-lab/alaya/pull/5). Moving this report does not rerun a model
or revalidate those implementations.
