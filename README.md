...
[`docs/output-recovery.md`](docs/output-recovery.md) — complete file-based task delivery and
recoverable tool-output previews, with Unicode pagination over the recorded trajectory.
